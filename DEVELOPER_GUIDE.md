...
9. Загруженный реестр содержит не более 500 профилей; обработка идет последовательно с checkpoint после каждого профиля, а эталонный Qwen profile использует `LOCAL_LLM_PARALLEL=1`.
