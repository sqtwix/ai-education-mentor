...
- **[agent.md](file:///c:/Users/ivan2/ai-education-mentor/agent.md)**: Полная архитектурная спецификация ИИ-агента, правила когортного матчинга и системные требования.
- **[USER_GUIDE.md](file:///c:/Users/ivan2/ai-education-mentor/USER_GUIDE.md)**: Пошаговая инструкция пользователя (служащего и методиста КУ СПб).
- **[ADMIN_GUIDE.md](file:///c:/Users/ivan2/ai-education-mentor/ADMIN_GUIDE.md)**: Руководство администратора по развертыванию, мониторингу и настройке локальных GGUF-моделей.
- **[MODEL_COMPARISON.md](file:///c:/Users/ivan2/ai-education-mentor/MODEL_COMPARISON.md)**: Отчет и сравнительное тестирование 3 групп моделей (DeepSeek, Sber GigaChat, Local Qwen).
...
flowchart TD
    ...
    C --> D["3. trajectory-justifier<br>Методическое обоснование каждого курса<br>на основе когортного бенчмарка"]
...
2. **Реальная база обучения (1 314 записей)**:
   * 323 реальных служащих Санкт-Петербурга по **36 должностям** (*Главный специалист, Ведущий специалист, Начальник отдела, Заместитель главы администрации и др.*) в 60 ИОГВ.
   * Рассчитаны когортные бенчмарки по парам `(Должность, ИОГВ)` и общегородские срезы.
...
* **Динамическое исключение дубликатов**: курсы со статусом «Пройден» гарантированно исключаются из рекомендаций (0-repeat rate 100%).
...
│   │   ├── data/            # 221 курс каталога 2025 и бенчмарки 1314 записей
...
├── MODEL_COMPARISON.md      # Сравнительное тестирование 3 групп моделей
